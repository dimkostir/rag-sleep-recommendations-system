...
import 'package:flutter_application_1/pages/psqi_history.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes:{
        ...
        '/psqi_history':(context) => const PSQIHistoryPage(),
        '/home_page': (context) => const HomePage(),
        '/change_pswd':(contex)=> const ChangePasswordPage()
      }
    );
  }
}
